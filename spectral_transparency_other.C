...
Int_t spectral_transparency_other(){
  TString fileN01 = "../data/30.04.2023/hist.root";
  TFile *f01 = new TFile(fileN01.Data());
  //   
  TGraph *gr_01 = (TGraph*)f01->Get("gr_rPlasticbag");
  TGraph *gr_02 = (TGraph*)f01->Get("gr_rRedplasticbag");
  TGraph *gr_03 = (TGraph*)f01->Get("gr_rGlass");
  TGraph *gr_04 = (TGraph*)f01->Get("gr_rGlasswithwater");
  //
